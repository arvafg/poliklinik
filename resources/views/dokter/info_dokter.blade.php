                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$dokter->alamat}}</td>
                                            <td><a href="/dokter/{{$dokter->id}}/edit_dokter" class='btn btn-warning btn-sm' ><i class="lnr lnr-pencil"></i></a>
                                            <a href="/dokter/{{$dokter->id}}/delete" class='btn btn-danger btn-sm'
        ...
        <div class="modal-dialog" role="document">
            ...
            <form action="/dokter/create" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input name="spesialis" type="text" class="form-control" id="spesialis"
                    aria-describedby="emailHelp" placeholder="Spesialis" required>
                </div>
